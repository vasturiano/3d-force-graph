...
| Method | Description | Default |
| --- | --- | :--: |
| <b>pauseAnimation</b>() | Pause the rendering cycle of the component, effectively freezing the current view and canceling all future user interaction. This method can be used to save performance in circumstances when a static image is sufficient. | |
